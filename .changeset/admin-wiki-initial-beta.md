...
- **Surfaces**: help under every field description, a guides panel in collection and global sidebars, a band on list views, block help inside every covered block, and a standalone reading view at `/admin/wiki`. Each is configurable or removable.
