...
To rotate a secret, delete the subscription and create a new one. [Code subscriptions](/webhooks/subscriptions#code-subscriptions) supply their secret from your environment instead.
