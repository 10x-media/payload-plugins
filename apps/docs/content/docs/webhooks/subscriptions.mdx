...
- `secret`: generated on create (or supply your own), revealed once, then masked and stored encrypted. A **Rotate secret** button replaces it in place. See [Signing](/webhooks/signing)
