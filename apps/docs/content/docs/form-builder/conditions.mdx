...
Conditions can reference [calculation](/docs/form-builder/calculations) fields; the server evaluates against the authoritative recomputed value.

Multi-step flows use the same engine for step branching: see [Multi-step forms](/docs/form-builder/multi-step).
