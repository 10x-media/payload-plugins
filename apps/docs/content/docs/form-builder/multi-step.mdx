...
The same tab carries the multi-step Next/Previous button labels, at the bottom, once the flow has at least one step; see [Form-level buttons](/form-builder/customization#form-level-buttons).
