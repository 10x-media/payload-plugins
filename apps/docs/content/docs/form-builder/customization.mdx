...
The plugin authors rich text in four places: [message](/form-builder/fields#message) content, the [consent](/form-builder/consent#rich-text-and-inline-links) statement, the response message, and [action bodies](/form-builder/actions#rich-text-bodies). None of them set an editor of their own, so all four inherit your config's `editor`, which is why the config must set one.
