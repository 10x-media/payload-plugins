...
Recall also pipes [calculation results](/docs/form-builder/calculations) into the success message: `Thanks, you scored {{score}} points!`
...
Any field can be marked hidden in the Advanced section of its settings. Hidden fields are captured and stored but not shown to the visitor. Pair with URL prefill to capture tracking context:
