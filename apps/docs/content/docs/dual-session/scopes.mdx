...
[Frontends and clients](/dual-session/clients) for setups where the website is not this Next app, [Custom auth](/dual-session/custom-auth) for your own SSO, [Limits](/dual-session/limits) for what scopes cannot cover.
