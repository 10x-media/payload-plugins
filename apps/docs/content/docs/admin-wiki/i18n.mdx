...
To call it a handbook, a playbook, or anything else, override these keys: `collectionPagesSingular`, `collectionPagesPlural`, `collectionMediaSingular`, `collectionMediaPlural`, `wikiViewTitle`, `wikiSubtitle`, and `wikiOpenWiki`.
