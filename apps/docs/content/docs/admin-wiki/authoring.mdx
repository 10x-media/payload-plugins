...
Four lists, one per target kind. **Collections**, **Globals**, and **Blocks** are pickers over what the plugin covers; **Fields** takes schema paths. See [Targeting](/admin-wiki/targets).
