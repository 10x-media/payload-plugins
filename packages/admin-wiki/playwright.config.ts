...
export default defineConfig({
	...
	webServer: {
		command: 'pnpm --filter @10x-media/admin-wiki-dev start',
		...
		env: {
			...
			DATABASE_URI_MONGO: `mongodb://localhost:${mongoPort}/admin-wiki_e2e?replicaSet=rs0&directConnection=true`,
			DATABASE_URI_POSTGRES: `postgres://e2e:e2e@localhost:${pgPort}/admin-wiki_e2e`,
