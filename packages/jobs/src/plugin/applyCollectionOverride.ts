...
/**
 * Consumer override applied as the outermost layer over the enhanced jobs
 * collection: top-level keys spread over ours, admin/access merge key-by-key,
 * consumer hooks append after plugin hooks, and `fields` composes through the
 * default-fields function. The slug is locked for correctness.
 */
