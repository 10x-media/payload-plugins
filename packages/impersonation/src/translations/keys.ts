...
export const keys = {
	...
	collectionFilter: 'impersonation:collectionFilter',
	...
	nextPage: 'impersonation:nextPage',
	noResults: 'impersonation:noResults',
	openDocument: 'impersonation:openDocument',
	openDrawer: 'impersonation:openDrawer',
	openWebsite: 'impersonation:openWebsite',
	pluginName: 'impersonation:pluginName',
	previousPage: 'impersonation:previousPage',
	reasonLabel: 'impersonation:reasonLabel',
	reasonPlaceholder: 'impersonation:reasonPlaceholder',
	returnTo: 'impersonation:returnTo',
	searchByName: 'impersonation:searchByName',
	searchUsers: 'impersonation:searchUsers',
	sessionActiveOnSite: 'impersonation:sessionActiveOnSite',
	sessionEndsAt: 'impersonation:sessionEndsAt',
	sessionEndsIn: 'impersonation:sessionEndsIn',
