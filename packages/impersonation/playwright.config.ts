...
export default defineConfig({
	...
	webServer: {
		command: 'pnpm --filter @10x-media/impersonation-dev start',
		...
		env: {
			...
			DATABASE_URI_MONGO: `mongodb://localhost:${mongoPort}/impersonation_e2e?replicaSet=rs0&directConnection=true`,
			DATABASE_URI_POSTGRES: `postgres://e2e:e2e@localhost:${pgPort}/impersonation_e2e`,
