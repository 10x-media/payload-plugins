...
The admin header gets **Impersonate**. Confirm, and you are that user until you exit. A bar on every admin route (including `/admin/unauthorized`) shows **Acting as** and **Return to**.
