...
export default defineConfig({
	...
	webServer: {
		command: 'pnpm --filter @10x-media/undo-redo-dev start',
		...
		env: {
			...
			DATABASE_URI_MONGO: `mongodb://localhost:${mongoPort}/undo-redo_e2e?replicaSet=rs0&directConnection=true`,
			DATABASE_URI_POSTGRES: `postgres://e2e:e2e@localhost:${pgPort}/undo-redo_e2e`,
