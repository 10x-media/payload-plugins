// biome-ignore-all lint/suspicious/noExplicitAny: This is function copied from @payloadcms/translations
// Why not use the original function - because then we need to add @payloadcms/translations to the dependencies
import type { JSX } from 'react'

type LabelType =
	| (() => JSX.Element)
	| ((args: { i18n: any; t: any }) => string)
	| JSX.Element
...
export const getTranslation = <T extends LabelType>(
	...
	if (typeof label === 'object' && !Object.hasOwn(label, '$$typeof')) {
	...
	if (typeof label === 'function') {
		return label({ i18n: i18n as any, t: i18n.t }) as unknown as T extends JSX.Element
			? JSX.Element
			: string
	}
