...
- **Native by construction**: 40px rows, Payload tokens, full `admin` prop contract, typed translations (en, de, es, fr, id, pt, ru, zh, uk, ar), function-form `overrides` on every factory.
