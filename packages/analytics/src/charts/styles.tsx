...
.analytics-chart { display: flex; flex-direction: column; width: 100%; }
.analytics-chart__plot { position: relative; flex: 1 1 auto; min-height: 0; width: 100%; }
.analytics-chart__legend { display: flex; flex-wrap: wrap; gap: 0.75rem; align-items: center; margin-bottom: 0.35rem; font-size: 0.6875rem; color: var(--theme-elevation-500); }
...
.analytics-chart__comparison { fill: none; stroke: var(--theme-elevation-500); stroke-width: 1.5; stroke-linecap: round; stroke-linejoin: round; vector-effect: non-scaling-stroke; }
.analytics-chart__dot--comparison { stroke: var(--theme-elevation-500); stroke-width: 1.5; }
...
.analytics-chart__active--comparison { fill: var(--theme-elevation-500); }
...
.analytics-chart__tooltip-comparison { display: flex; gap: 0.5rem; justify-content: space-between; margin-top: 0.2rem; color: var(--theme-elevation-500); }
.analytics-chart__tooltip-previous { font-weight: 600; font-variant-numeric: tabular-nums; }
