...
The charts are dependency-free SVG and CSS themed with Payload's design tokens. Series colors come from `--analytics-chart-1` and `--analytics-chart-2`, which a consuming app can override in its admin stylesheet.
