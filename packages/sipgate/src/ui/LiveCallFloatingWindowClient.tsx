...
const PhoneIcon = ({ color = 'currentColor' }: { color?: string }) => (
	<svg
		...
		aria-hidden="true"
	>
		<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.5 19.79 19.79 0 0 1 1.59 5 2 2 0 0 1 3.59 3h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 10a16 16 0 0 0 6.29 6.29l1.36-.93a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 17.92z" />
	</svg>
)
		...
		<div style={{ display: 'flex', flexWrap: 'wrap', gap: 'calc(var(--base) * 0.35)' }}>
			...
			{call.status === 'active' && (
				<>
					...
					<span title="Mute is not yet supported by sipgate Neo">
						<Button
							type="button"
							buttonStyle="secondary"
							size="small"
						...
						{calls.length === 0 ? (
							...
							calls.map((call) => (
								<CallCard
									...
									onMute={() => sendRtcm(call, 'mute').catch(() => {})}
									onRecord={() => sendRtcm(call, 'recordings').catch(() => {})}
