...
export interface Config {
  ...
  jobs: {
    tasks: {
      sipgateSyncCallHistory: TaskSipgateSyncCallHistory;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'sipgateSyncCallHistory';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'sipgateSyncCallHistory') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskSipgateSyncCallHistory".
 */
export interface TaskSipgateSyncCallHistory {
  input: {
    limit?: number | null;
    from?: string | null;
    to?: string | null;
