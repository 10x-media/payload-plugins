...
export default definePluginBuild({
	entry: {
		...
		// '@10x-media/wildix/ui/ClickToDialField'), so unlike the exports/*
		...
		'ui/WildixSyncButton': 'src/ui/WildixSyncButton.tsx',
		'ui/WildixOAuthButton': 'src/ui/WildixOAuthButton.tsx',
	},
})
