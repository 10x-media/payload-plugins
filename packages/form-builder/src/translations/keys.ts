...
export const keys = {
	...
	actionConfigToDescription: 'formBuilder:action.config.toDescription',
	...
	pollCloseSuccess: 'formBuilder:poll.close.success',
	pollCloseFailed: 'formBuilder:poll.close.failed',
