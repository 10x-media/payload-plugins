...
export const de: Record<TranslationKey, string> = {
	...
	[keys.calcBuilderWeights]: 'Gewichtete Antworten',
	[keys.calcBuilderAddExpression]: 'Ausdruck hinzufügen',
	[keys.calcBuilderPickField]: 'Feld wählen',
	[keys.calcBuilderJsonMode]: 'Als JSON bearbeiten',
	[keys.calcBuilderVisualMode]: 'Visueller Editor',
	[keys.calcBuilderJsonInvalid]: 'Kein gültiger Ausdruck.',
	...
	[keys.calcBuilderUnwrap]: 'Entfernen, Inhalt behalten',
