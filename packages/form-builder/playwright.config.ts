...
export default defineConfig({
	...
	webServer: {
		command: 'pnpm --filter @10x-media/form-builder-dev start',
		...
		env: {
			...
			DATABASE_URI_MONGO: `mongodb://localhost:${mongoPort}/form-builder_e2e?replicaSet=rs0&directConnection=true`,
			DATABASE_URI_POSTGRES: `postgres://e2e:e2e@localhost:${pgPort}/form-builder_e2e`,
